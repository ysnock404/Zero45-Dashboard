...
- [ ] **Criar estrutura de páginas** (pastas vazias primeiro)
...
- [ ] **Tornar dados dinâmicos** (não hardcoded)
...
- [ ] **Gráfico real** (substituir placeholder)
  - [ ] Integrar Recharts
